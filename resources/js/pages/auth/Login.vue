...
<template>
    <AuthBase>
        ...
        <!-- Status message (e.g. setelah password reset) -->
        <div
            v-if="status"
            class="mb-5 rounded-lg bg-green-50 px-4 py-3 text-center text-sm text-green-700"
        >
            {{ status }}
        </div>
        ...
        >
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <div class="relative">
                    ...
                    <Input
                        ...
                        class="h-11 rounded-[10px] border-gray-200 pl-10 text-sm"
                    />
                </div>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <div class="relative">
                    ...
                    <Input
                        ...
                        class="h-11 rounded-[10px] border-gray-200 pl-10 pr-10 text-sm"
                    />
                    <button
                        type="button"
            ...
            <div class="flex items-center justify-between">
                ...
                <TextLink
                    ...
                    :href="request()"
                    class="text-[13px] font-medium text-blue-600 hover:text-blue-700"
                    :tabindex="5"
                >
                    Forgot password?
                </TextLink>
            ...
            <Button
                type="submit"
                class="mt-1 h-11 w-full rounded-[10px] text-sm font-semibold"
                :tabindex="4"
                :disabled="processing"
            >
        ...
        <div class="flex gap-3">
            <Button
                variant="outline"
                type="button"
                class="h-11 flex-1 rounded-[10px] text-[13px] font-medium text-gray-700"
            >
                <!-- Google icon -->
            ...
            >
                <!-- GitHub icon -->
                <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" class="shrink-0">
